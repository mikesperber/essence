...
(define-test-case g08 toy-grammars-tests
  (check (parse g08 1 'lr i08-1) => #f)
  (check (parse g08 1 'slr i08-1) => #f)
  (check-exception (parse g08 1 'lr i08-2))
  (check-exception (parse g08 1 'slr i08-2))
  (check-exception (parse g08 1 'lr i08-3))
  (check-exception (parse g08 1 'slr i08-3)))

(define-test-case g10 toy-grammars-tests
  (check (parse g10 1 'lr i10-1) => 147)
  (check (parse g10 1 'slr i10-1) => 147)
  (check-exception (parse g10 1 'lr i10-2))
  (check-exception (parse g10 1 'slr i10-2))
...
(define-test-case g10-error toy-grammars-tests
  ...
  (check (parse g10-error 1 'lr i10e-2) => 28)
  (check (parse g10-error 1 'slr i10e-2) => 28)
  (check-exception (parse g10-error 1 'lr i10e-3))
  (check-exception (parse g10-error 1 'slr i10e-3)))

(define-test-case g14 toy-grammars-tests
  (check (parse g14 1 'lr i14-1) => #f)
  (check (parse g14 1 'slr i14-1) => #f))
